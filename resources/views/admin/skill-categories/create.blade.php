...
@section('title', 'スキルカテゴリ作成')
@section('page-title', 'スキルカテゴリ作成')

@section('content')
    <div class="max-w-2xl">
        <div class="bg-white shadow-sm rounded-lg">
            <div class="px-6 py-4 border-b border-gray-200">
                <h1 class="text-lg font-medium text-gray-900">スキルカテゴリを追加</h1>
            </div>

            <form method="POST" action="{{ route('admin.skill-categories.store') }}" class="p-6 space-y-6">
                @csrf
